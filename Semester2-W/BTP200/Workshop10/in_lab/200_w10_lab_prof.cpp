...
int main()
{
    ...
    // Q2. print whether violent crime rate is going up or down between 2000 and 2005
    ...
    // Q3 print the GTA rate accurate to 0 decimal places
    cout << "There are ";
    cout.precision(2);
    cout <<
        (average(grandTheftAuto, N)/ 1E6)
