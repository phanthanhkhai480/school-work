...
function draw() {
  ...
  textFont('Arial');
  //insert the text and coordination where to start
  text('Pixel Image', 50, 250);
  //draw a circle that moving horizontal
  drawCircleHorizontal();
}
...
function drawCircleHorizontal() {
  //Draw a circle
  //fill the circle with colour
  fill(100);
  //create an ellipse with size of 30 in horizontal and 24 in vertical
  //x and y represent the coordinator in the screen
  ellipse(x, y, 30, 24);
  ...
  // Reset to the end of right side
  if (x < 0) {  x = width;  }
}
